...
const GoldCard = ({ index }) => {
    const [showModal, setShowModal] = useState(false)
    return (
        <>
            <div className="card h-72 w-56 border border-[#0A66B4] flex flex-col justify-center items-center gap-5" onClick={() => { setShowModal(true) }}>
            ...
            {
                showModal && <GoldModal setShowModal={setShowModal} index={index}/>
            }
        </>
    )
}

const GoldModal = ({setShowModal,index}) => {
    ...
    return (
        <div className="border border-black bg-[#333333] h-[40rem] w-[56rem] fixed inset-0 m-auto">
            <div className="h-16 border-b border-white flex justify-between items-center w-[95%] mx-auto">
                <span className='text-2xl text-white'>Ranked {index} in Gold Tier</span>
