...
function Activity({ setIsLogin,id }) {
    ...
    return (
        <div className="w-[532px] h-[252px] bg-white rounded-3xl flex flex-col items-center mt-[10px]">
            ...
            <div className="mt-[15px] flex flex-col items-center gap-[13px]">
                <div className="w-[459px] h-[20px] flex items-center justify-between">
                    <span className='text-base font-medium'>Service</span>
                    <div className="w-[313px] h-full bg-[#FAC1EA] rounded-[20px] flex justify-between items-center overflow-hidden">
