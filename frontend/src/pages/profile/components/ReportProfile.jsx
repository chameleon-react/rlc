...
function ReportProfile({ setIsLogin, id }) {
    ...
    return (
        <div className=" lg:absolute bottom-3 right-7 flex gap-1 text-[#513968] mt-5 lg:mt-0 float-right lg:float-none">
            ...
            {
                report && <div className="form lg:absolute w-64 bg-white border -inset-x-2 mx-auto top-8 p-3 rounded-lg z-40">
