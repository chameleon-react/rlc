            ...
            <div className=" pb-[60px] h-full " style={{ background: 'transparent linear-gradient(180deg, #A18CD1 0%, #FBC2EB 100%) 0% 0% no-repeat padding-box' }}>
                <div className="mx-auto">
                    ...
                    <div className="h-12 max-w-[1244px] bg-[#513968] px-[18px] flex justify-between items-center text-white text-sm mx-auto">
                        <button className='w-[81px] h-[29px] rounded-2xl bg-[#946FB7] hover:w-[90px] hover:h-[35px] hover:text-lg duration-200' onClick={() => { id !== 1 && navigate(`/profile/${Number(id) - 1}`) }}>Previous</button>
                        <Contact data={data} />
                        <button className='w-[81px] h-[29px] rounded-2xl bg-[#946FB7] hover:w-[90px] hover:h-[35px] hover:text-lg duration-200' onClick={() => { navigate(`/profile/${Number(id) + 1}`) }}>Next</button>
                    </div>
                    <div className="w-full min-h-[835px] flex justify-center flex-wrap">
                        ...
                        <div className="left w-[622px] flex-shrink-0">
                            <img src={data.profilePhoto} className='w-full h-[771px] object-cover' alt={data.adsTitle} />
                        </div>
