  ...
  return (
    ...
    <div className="footer  px-5 md:px-[100px] bg-[#17191E] text-white pt-3 flex flex-col gap-3 pb-5">
        ...
        <div className="flex justify-center lg:justify-start flex-wrap text-[#FB0202] gap-[15px]">
         <Link to={'/'}><button className='w-48'>Forum</button></Link>
         <Link to={'/static/about'}><button className='w-48'>About</button></Link>
         <Link to={'/'}><button className='w-48'>Blog</button></Link>
         <Link to={'/'}><button className='w-48'>Advertise Escort Services</button></Link>
         <Link to={'/'}><button className='w-48'>Help for Advertisers</button></Link>
         <Link to={'/'}><button className='w-48'>Guide to seeing an escort</button></Link>
        </div>
        ...
        <div className="flex gap-[18px] justify-center md:justify-start text-sm text-[#FB0202]">
            ...
            <Link to={'/static/TermsAndConditions'}>
